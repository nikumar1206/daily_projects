  ...
  _createClass(AutoComplete, [{
    ...
    value: function matches() {
      ...
      this.props.names.forEach(function (name) {
        var sub = name.slice(0, _this2.state.inputVal.length);
        if (sub.toLowerCase() === _this2.state.inputVal.toLowerCase()) {
          matches.push(name);
        }
      });
        ...
        return _react2.default.createElement(
          'li',
          {
            ...
            onClick: function onClick() {
              debugger;
              return _this2.props.onTabChosen(index);
            }
          },
          title,
          ' '
...
var Tabs = function (_React$Component2) {
  ...
  function Tabs(props) {
    ...
    var _this3 = _possibleConstructorReturn(this, (Tabs.__proto__ || Object.getPrototypeOf(Tabs)).call(this, props));

    _this3.state = {
      selectedPane: 0
    };
    _this3.selectTab = _this3.selectTab.bind(_this3);
    return _this3;
  }
  ...
  _createClass(Tabs, [{
    ...
    value: function selectTab(num) {
      debugger;
      this.setState({ selectedPane: num }, function () {
        debugger;
      });
      debugger;
    }
...
var _auto = __webpack_require__(/*! ./auto */ "./frontend/auto.jsx");
...
function Root() {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_auto2.default, { names: names })
    )
  );
}
